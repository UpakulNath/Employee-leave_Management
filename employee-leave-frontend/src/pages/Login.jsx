...
function Login() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Handle enterprise authentication logic here
      ...
      <div className="w-full max-w-5xl bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden grid grid-cols-1 lg:grid-cols-2 min-h-[600px]">
        ...
        <div className="hidden lg:flex flex-col justify-between bg-gradient-to-br from-indigo-600 to-blue-700 text-white p-12">
          <div>
            <div className="flex items-center gap-2 mb-8">
              ...
              <span className="font-semibold tracking-wide text-sm uppercase">TalentFlow</span>
            </div>
            ...
            <p className="text-blue-100 leading-relaxed max-w-sm">
              Streamline leave requests, monitor balances, and manage team calendars through our unified enterprise portal.
            </p>
          </div>
        ...
        <div className="p-8 sm:p-16 flex flex-col justify-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full border border-slate-200 rounded-xl px-4 py-3 text-slate-900 placeholder-slate-400 focus:outline-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition duration-200"
              />
            </div>
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 text-slate-600 cursor-pointer select-none">
                <input 
                  ...
                  className="rounded border-slate-300 text-indigo-600 focus:ring-indigo-500 h-4 w-4 transition duration-150" 
                />
            ...
            <button
              type="submit"
              className="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-3 rounded-xl font-medium shadow-sm hover:shadow-md transition duration-200 focus:outline-none focus:ring-4 focus:ring-indigo-500/20"
            >
              Sign In
            </button>
          </form>
          ...
          <p className="text-center text-sm text-slate-600">
            ...
            <Link
              to="/register"
              className="text-indigo-600 font-semibold hover:text-indigo-700 transition underline-offset-4 hover:underline"
            >
              Request an account
            </Link>
          </p>
